        ...
        <div className="max-w-xl w-full">
          <div className="flex mt-10 items-center space-x-3">
            ...
            <p className="text-left font-medium">
              Write the dream story and get ideas{" "}
              <span className="text-slate-500">
                (or write a few sentences about your story)
              </span>
              .
            </p>
          </div>
          <textarea
            ...
            placeholder={
              "e.g. Write me a story about a girl and three little piggies"
            }
          />
